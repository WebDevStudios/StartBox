...
class sb_featured_content_widget extends WP_Widget {
	...
	?>
		...
		<p>
			...
			<select class="widefat content-selector" id="<?php echo $this->get_field_id('content_type'); ?>" name="<?php echo $this->get_field_name('content_type'); ?>">
				<?php
		...
		<div id="<?php echo $this->get_field_id('post_options'); ?>" class="content-settings post-settings"<?php if( $instance['content_type'] == 'page' ){ echo ' style="display:none;"'; }?>>
			<p>
			...
			<p>
				...
				<select class="widefat" id="<?php echo $this->get_field_id('post_orderby'); ?>" name="<?php echo $this->get_field_name('post_orderby'); ?>">
			...
			<p>
				...
				<input id="<?php echo $this->get_field_id('post_count'); ?>" name="<?php echo $this->get_field_name('post_count'); ?>" type="text" value="<?php echo $instance['post_count']; ?>" size="3" />
			</p>
			
			<p>
				<input class="checkbox advanced-toggle" type="checkbox" <?php checked( $instance['post_showtitle'], 'on' ); ?> id="<?php echo $this->get_field_id('post_showtitle'); ?>" name="<?php echo $this->get_field_name('post_showtitle'); ?>'); ?>" />
				<label for="<?php echo $this->get_field_id('post_showtitle'); ?>"><?php _e( 'Display Post Title', 'startbox' ) ?></label>
			</p>
			
			<p>
				<input class="checkbox advanced-toggle" type="checkbox" <?php checked( $instance['post_showmeta'], 'on' ); ?> id="<?php echo $this->get_field_id('post_showmeta'); ?>" name="<?php echo $this->get_field_name('post_showmeta'); ?>'); ?>" />
				<label for="<?php echo $this->get_field_id('post_showmeta'); ?>"><?php _e( 'Display Meta Information', 'startbox' ) ?></label>
			</p>
			<div id="<?php echo $this->get_field_id('post_info'); ?>" class="advanced-settings"<?php $this->advanced_hide($instance['post_showmeta']); ?>>
				<p>
					<label for="<?php echo $this->get_field_id('post_meta'); ?>"><?php _e( 'Display Meta Information: ', 'startbox' ); ?></label>
					<input class="widefat" id="<?php echo $this->get_field_id('post_meta'); ?>" name="<?php echo $this->get_field_name('post_meta'); ?>" type="text" value="<?php echo $instance['post_meta']; ?>" /><br/>
			...
			<p>
				<input class="checkbox advanced-toggle" type="checkbox" <?php checked( $instance['post_showimage'], 'on' ); ?> id="<?php echo $this->get_field_id('post_showimage'); ?>" name="<?php echo $this->get_field_name('post_showimage'); ?>'); ?>" />
				<label for="<?php echo $this->get_field_id('post_showimage'); ?>"> <?php _e( 'Display Featured Image', 'startbox' ); ?></label>
			</p>
			<div id="<?php echo $this->get_field_id('post_image'); ?>" class="advanced-settings"<?php $this->advanced_hide($instance['post_showimage']); ?>>
				<p>
					<label for="<?php echo $this->get_field_id('post_imagewidth'); ?>"><?php _e( 'Image Size: ', 'startbox' ); ?></label>
					<input id="<?php echo $this->get_field_id('post_imagewidth'); ?>" name="<?php echo $this->get_field_name('post_imagewidth'); ?>" type="text" size="3" value="<?php echo $instance['post_imagewidth']; ?>" />
					x
					<input id="<?php echo $this->get_field_id('post_imageheight'); ?>" name="<?php echo $this->get_field_name('post_imageheight'); ?>" type="text" size="3" value="<?php echo $instance['post_imageheight']; ?>" />px
				</p>
				<p>
					<label for="<?php echo $this->get_field_id('post_imagealignment'); ?>"><?php _e( 'Image Alignment:', 'startbox' ); ?></label>
					<select id="<?php echo $this->get_field_id('post_imagealignment'); ?>" name="<?php echo $this->get_field_name('post_imagealignment'); ?>">
				...
				<p>
					...
					<select id="<?php echo $this->get_field_id('post_imagelocation'); ?>" name="<?php echo $this->get_field_name('post_imagelocation'); ?>">
			...
			<p>
				<input class="checkbox advanced-toggle" type="checkbox" <?php checked( $instance['post_showcontent'], 'on' ); ?> id="<?php echo $this->get_field_id('post_showcontent'); ?>" name="<?php echo $this->get_field_name('post_showcontent'); ?>" />
				<label for="<?php echo $this->get_field_id('post_showcontent'); ?>"><?php _e( 'Display Post Content', 'startbox' ); ?></label>
			</p>
			<div id="<?php echo $this->get_field_id('post_contents'); ?>" class="advanced-settings"<?php $this->advanced_hide($instance['post_showcontent']); ?>>
				<p>
					<label for="<?php echo $this->get_field_id('post_content'); ?>"><?php _e( 'Content:', 'startbox' ); ?></label>
					<select id="<?php echo $this->get_field_id('post_content'); ?>" name="<?php echo $this->get_field_name('post_content'); ?>">
				...
				<p>
					...
					<input class="widefat" id="<?php echo $this->get_field_id('post_readmore'); ?>" name="<?php echo $this->get_field_name('post_readmore'); ?>" type="text" value="<?php echo $instance['post_readmore']; ?>" />
			...
			<p>
				<input class="checkbox advanced-toggle" type="checkbox" <?php checked( $instance['post_showmore'], 'on' ); ?> id="<?php echo $this->get_field_id('post_showmore'); ?>" name="<?php echo $this->get_field_name('post_showmore'); ?>'); ?>" />
				<label for="<?php echo $this->get_field_id('post_showmore'); ?>"><?php _e( 'Display Link to More Posts', 'startbox' ); ?></label>
			</p>
			<div id="<?php echo $this->get_field_id('post_more'); ?>" class="advanced-settings"<?php $this->advanced_hide($instance['post_showmore']); ?>>
				<p>
					<label for="<?php echo $this->get_field_id('post_morelink'); ?>"><?php _e( 'Link URL: ', 'startbox' ) ?></label>
					<input class="widefat" id="<?php echo $this->get_field_id('post_morelink'); ?>" name="<?php echo $this->get_field_name('post_morelink'); ?>" type="text" value="<?php echo $instance['post_morelink']; ?>" /><br/>
				</p>
				<p>
					<label for="<?php echo $this->get_field_id('post_moretext'); ?>"><?php _e( 'Link Text: ', 'startbox' ) ?></label>
					<input class="widefat" id="<?php echo $this->get_field_id('post_moretext'); ?>" name="<?php echo $this->get_field_name('post_moretext'); ?>" type="text" value="<?php echo $instance['post_moretext']; ?>" />
				</p>
				<p>
					<label for="<?php echo $this->get_field_id('post_morelocation'); ?>"><?php _e( 'Link Position:', 'startbox' ) ?></label>
					<select id="<?php echo $this->get_field_id('post_morelocation'); ?>" name="<?php echo $this->get_field_name('post_morelocation'); ?>">
			...
			<p>
				<input class="checkbox advanced-toggle" type="checkbox" <?php checked( $instance['post_showadvanced'], 'on' ); ?> id="<?php echo $this->get_field_id('post_showadvanced'); ?>" name="<?php echo $this->get_field_name('post_showadvanced'); ?>'); ?>" />
				<label for="<?php echo $this->get_field_id('post_showadvanced'); ?>"><?php _e('Display Advanced Query Options', 'startbox' ) ?></label>
			</p>
			<div id="<?php echo $this->get_field_id('post_advanced'); ?>" class="advanced-settings" <?php $this->advanced_hide($instance['post_showadvanced']); ?>>
				<p>
					<label for="<?php echo $this->get_field_id('post_morecount'); ?>"><?php _e( 'Display ', 'startbox' ) ?></label>
					<input id="<?php echo $this->get_field_id('post_morecount'); ?>" name="<?php echo $this->get_field_name('post_morecount'); ?>" type="text" value="<?php echo $instance['post_morecount']; ?>" size="3" />
				...
				<p>
					...
					<input class="widefat" id="<?php echo $this->get_field_id('post_exclude'); ?>" name="<?php echo $this->get_field_name('post_exclude'); ?>" type="text" value="<?php echo $instance['post_exclude']; ?>" /><br/>
				...
				<p>
					...
					<input class="widefat" id="<?php echo $this->get_field_id('post_include'); ?>" name="<?php echo $this->get_field_name('post_include'); ?>" type="text" value="<?php echo $instance['post_include']; ?>" /><br/>
					<span style="font-size:smaller"><?php _e( 'Comma-separated list of post ID\'s.', 'startbox' ) ?></span>
				</p>
				<p>
					<label for="<?php echo $this->get_field_id('post_offset'); ?>"><?php _e( 'Offset posts: ', 'startbox' ) ?></label>
					<input id="<?php echo $this->get_field_id('post_offset'); ?>" name="<?php echo $this->get_field_name('post_offset'); ?>" type="text" value="<?php echo $instance['post_offset']; ?>" /><br/>
		...
		<div id="<?php echo $this->get_field_id('page_options'); ?>" class="content-settings page-settings"<?php if($instance['content_type'] == 'posts'){ echo ' style="display:none;"'; }?>>
			<p>
			...
			<hr/>
			<p>
				<input class="checkbox advanced-toggle" type="checkbox" <?php checked( $instance['page_showimage'], 'on' ); ?> id="<?php echo $this->get_field_id('page_showimage'); ?>" name="<?php echo $this->get_field_name('page_showimage'); ?>'); ?>" />
				<label for="<?php echo $this->get_field_id('page_showimage'); ?>"> <?php _e('Display Featured Image', 'startbox' ) ?></label>
			</p>
			<div id="<?php echo $this->get_field_id('page_image'); ?>" class="advanced-settings"<?php $this->advanced_hide($instance['page_showimage']); ?>>
				<p>
					<label for="<?php echo $this->get_field_id('page_imagewidth'); ?>"><?php _e( 'Image Size: ', 'startbox' ) ?></label>
					<input id="<?php echo $this->get_field_id('page_imagewidth'); ?>" name="<?php echo $this->get_field_name('page_imagewidth'); ?>" type="text" size="3" value="<?php echo $instance['page_imagewidth']; ?>" />
					x
					<input id="<?php echo $this->get_field_id('page_imageheight'); ?>" name="<?php echo $this->get_field_name('page_imageheight'); ?>" type="text" size="3" value="<?php echo $instance['page_imageheight']; ?>" />px
				</p>
				<p>
					<label for="<?php echo $this->get_field_id('page_imagealignment'); ?>"><?php _e( 'Image Alignment:', 'startbox' ) ?></label>
					<select id="<?php echo $this->get_field_id('page_imagealignment'); ?>" name="<?php echo $this->get_field_name('page_imagealignment'); ?>">
				...
				<p>
					...
					<select id="<?php echo $this->get_field_id('page_imagelocation'); ?>" name="<?php echo $this->get_field_name('page_imagelocation'); ?>">
			...
			<p>
				<input class="checkbox advanced-toggle" type="checkbox" <?php checked( $instance['page_showcontent'], 'on' ); ?> id="<?php echo $this->get_field_id('page_showcontent'); ?>" name="<?php echo $this->get_field_name('page_showcontent'); ?>'); ?>" />
				<label for="<?php echo $this->get_field_id('page_showcontent'); ?>"><?php _e( 'Display Page Content', 'startbox' ); ?></label>
			</p>
			<div id="<?php echo $this->get_field_id('page_content'); ?>" class="advanced-settings"<?php $this->advanced_hide($instance['page_showcontent']); ?>>
				<p>
				...
				<p>
					...
					<input class="widefat" id="<?php echo $this->get_field_id('page_readmore'); ?>" name="<?php echo $this->get_field_name('page_readmore'); ?>" type="text" value="<?php echo $instance['page_readmore']; ?>" />
					<span style="font-size:smaller"><?php _e( 'Leave blank to hide the Read More link.', 'startbox' ); ?></span>
				</p>
			</div>
			<hr/>
