...
class SB_Sidebars {
	...
	function default_sidebars() {
		...
		if (sb_is_pagetemplate_active('page-tertiarysidebar.php')) { $this->register_sidebar( array( 'name' => 'Tertiary Sidebar', 'id' => 'tertiary_widget_area', 'description' => __('This sidebar replaces Primary Sidebar for the Tertiary page template.', 'startbox'), 'editable' => 1 ) ); }
