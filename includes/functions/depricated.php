...
function sb_after_footer() { _deprecated_function( __FUNCTION__, '2.6', 'do_action( \'sb_after_footer\' )' ); do_action('sb_after_footer'); } // inside div#footer_wrap, after div#footer
